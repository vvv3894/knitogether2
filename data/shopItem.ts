...
export const shopItems: ShopItem[] = [
  ...
  },
  {
    ...
    category: "상의",
    description:
      "몸체는 대바늘을 사용하고 칼라와 소매는 코바늘을 사용하는 디자인입니다. 네크라인이 깊게 파여있어 레이어드해서 코디하는 것을 추천드립니다.",
  ...
  },
  {
    ...
    category: "외투",
    description:
      "전체적으로 다양한 색상이 어우러져 독특한 느낌의 디자인입니다. 장식 링이 많아(18개) 조금 어렵습니다!",
  ...
  },
  {
    ...
    category: "외투",
    description:
      "높은 위치에서 허리라인을 강조하여 페미닌한 느낌을 주고 다리가 길어보이는 디자인입니다.",
    needles: ["대바늘 5.5mm"],
    writer: "Antique Pattern Library",
    yarns: [
  ...
  },
  {
    ...
    category: "외투",
    description:
      "브라이어 스티치로 마감한 칼라가 독특한 느낌을 주는 롱기장의 가디건입니다.",
    needles: ["대바늘 5.5mm"],
    writer: "Antique Pattern Library",
    yarns: [
  ...
  },
  {
    ...
    category: "상의",
    description:
      "넓은 허리띠로 포인트를 준 기장감이 있는 스웨터입니다. 네크라인이 깊게 파여있어 레이어드해서 코디하는 것을 추천드립니다.",
    needles: ["대바늘 5.5mm"],
    writer: "Antique Pattern Library",
    yarns: [
  ...
  },
  {
    ...
    category: "상의",
    description:
      "직선적인 느낌의 롱스웨터입니다. 네크라인이 깊게 파여있어 레이어드해서 코디하는 것을 추천드립니다.",
    needles: ["코바늘 5.5mm"],
    writer: "Antique Pattern Library",
    yarns: [
